...
class MudServer(object):    
    ...
    def __init__(self):
        ...
        self._listen_socket.bind(("0.0.0.0",8888))
    ...
    def send_message(self,to,message,newline=True):
        """    
    ...
    def send_prompt(self,to):
        """
        send the default prompt, letting the user know its their turn to input 
        a command.
        """
        self.send_message(to,">> ",newline=False)
    ...
    def _attempt_send(self,clid,data):
        ...
        if version < '3' and type(data)!=unicode: data = unicode(data,"latin1")
        try:
    ...
    def _check_for_new_connections(self):
        ...
        rlist,wlist,xlist = select([self._listen_socket],[],[],0)
        ...
        self._clients[self._nextid] = MudServer._Client(joined_socket,addr[0],"",time())
    ...
    def _check_for_disconnected(self):
        ...
        for id,cl in list(self._clients.items()):
            ...
            if time() - cl.lastcheck < 5.0: continue
    ...
    def _check_for_messages(self):
        ...
        for id,cl in list(self._clients.items()):
            ...
            rlist,wlist,xlist = select([cl.socket],[],[],0)
